...
![alt text](images/gif6-1.gif)

✅ 集成 Mermaid 框架，流程图、时序图、类图一键生成，逻辑结构跃然板上  
![alt text](images/gif6-2.gif)

✅ 智能二值化处理，手绘图稿秒转丝印/阻焊开窗，打造极具个人辨识度的 PCB  
![alt text](images/gif6-3.gif)

✅ 支持彩色原图一键转换，适配彩色丝印工艺，让你的自制 Logo 与彩印 PCB 脱颖而出  
![alt text](images/gif6-4.gif)

## 参考

- 致谢 [excalidraw组织](https://github.com/excalidraw/excalidraw) 与 [社区贡献者](https://github.com/excalidraw/excalidraw/graphs/contributors)
